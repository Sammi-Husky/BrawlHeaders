...
public:
    ...
    enum VariableInt {
        ...
        Variable_Int_Status_Last_Transition_Group_Id = 0x4324,
        Variable_Int_Status_Last_Transition_Unit_Id = 0x4325,
        Variable_Int_Pickable_Item_Size = 0x4326,
        Variable_Int_Pickable_Item_Kind = 0x4327,
        Variable_Int_Have_Item_Size = 0x4328,
        Variable_Int_Have_Item_Kind = 0x4329,
        Variable_Int_Motion_Partial_1_Kind = 0x432A,
        Variable_Int_Motion_Partial_2_Kind = 0x432B,
        Variable_Int_Motion_Other_1_Kind = 0x432C,
        Variable_Int_Motion_Other_2_Kind = 0x432D,
        Variable_Int_Motion_Other_3_Kind = 0x432E,
        Variable_Int_Motion_Other_4_Kind = 0x432F,
        Variable_Int_Motion_Other_5_Kind = 0x4330,
