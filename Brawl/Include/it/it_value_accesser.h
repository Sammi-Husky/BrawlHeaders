...
public:
    enum ParamFloat {
        ...
        Specialized_Param_Float_Pickup_Range_OffX = 0xD57,
        Specialized_Param_Float_Pickup_Range_OffY = 0xD58,
        Specialized_Param_Float_Pickup_Range_SizeW = 0xD59,
        Specialized_Param_Float_Pickup_Range_SizeH = 0xD5A,
