...
//        Common_Param_Float_Dedede_SwallowedEscape_3 = 3422,
    ...
    enum VariableFloat {
        Var_Float_Kinetic_Sum_Speed = 1000,
        Var_Float_Kinetic_Sum_Speed_X = 1001,
        Var_Float_Kinetic_Sum_Speed_Y = 1002,
        Var_Float_Motion_Trans_Move_Speed_X = 1003,
        Var_Float_Motion_Trans_Move_Speed_Y = 1004,
        Var_Float_Kinetic_Energy_Damage_Speed = 1005,
        Var_Float_Kinetic_Energy_Damage_Speed_X = 1006,
        Var_Float_Kinetic_Energy_Damage_Speed_X_Rv = 1007,
        Var_Float_Kinetic_Energy_Damage_Speed_Y = 1008,
        Var_Float_Kinetic_Energy_Damage_Speed_Y_Rv = 1009,
        Var_Float_Controller_Stick_X = 1010,
        Var_Float_Controller_Stick_X_Lr = 1011,
        Var_Float_Controller_Stick_X_Lr_Rv = 1012,
        Var_Float_Controller_Stick_X_Abs = 1013,
        Var_Float_Controller_Stick_X_Rv = 1014,

        Var_Float_Controller_Stick_X_Kinetic_Sum_Speed_Lr = 1017,
        Var_Float_Controller_Stick_Y = 1018,
        Var_Float_Controller_Stick_Y_Abs = 1019,
        Var_Float_Controller_Stick_Y_Rv = 1020,
        Var_Float_Controller_Stick_Dir = 1021,
        Var_Float_Controller_Stick_Prev_X = 1022,
        Var_Float_Controller_Stick_Prev_X_Lr = 1023,
        Var_Float_Controller_Stick_Prev_X_Lr_Rv = 1024,
        Var_Float_Controller_Stick_Prev_X_Abs = 1025,
        Var_Float_Controller_Stick_Prev_Y = 1026,
        Var_Float_Controller_Stick_Prev_Y_Abs = 1027,
        Var_Float_Controller_Stick_Prev_Y_Rv = 1028,
        Var_Float_Throw_Item_Speed = 1029,
        Var_Float_Throw_Item_Angle = 1030,
        Var_Float_Throw_Item_Power = 1031,
        Var_Float_Item_Pickup_Light_Range = 1032,
        Var_Float_Item_Swing_Motion_Rate = 1033,
        Var_Float_Tread_Jump_Speed_Y = 1034,
        Var_Float_Motion_Frame = 1035,
        Var_Float_Motion_Rate = 1036,
    };

    enum VariableInt {
        Var_Int_Combo_Count = 21000,
        Var_Int_Controller_Flick_X = 21001,
        Var_Int_Controller_Flick_Y = 21002,
        Var_Int_Controller_Flick_No_Reset_X = 21003,
        Var_Int_Controller_Flick_No_Reset_Y = 21004,
        Var_Int_Controller_Flick_After_X = 21005,
        Var_Int_Controller_Flick_After_Y = 21006,
        Var_Int_Controller_Flick_X_Dir = 21007,
        Var_Int_Controller_Flick_Y_Dir = 21008,
        Var_Int_Controller_Trigger_1_Count = 21009,
        Var_Int_Controller_Trigger_1_Count_Prev = 21010,
        Var_Int_Controller_Trigger_2_Count = 21011,
        Var_Int_Controller_Trigger_2_Count_Prev = 21012,
        Var_Int_Controller_Trigger_3_Count = 21013,
        Var_Int_Controller_Trigger_3_Count_Prev = 21014,
        Var_Int_Controller_Trigger_4_Count = 21015,
        Var_Int_Controller_Trigger_4_Count_Prev = 21016,
        Var_Int_Controller_Trigger_5_Count = 21017,
        Var_Int_Controller_Trigger_5_Count_Prev = 21018,
        Var_Int_Controller_Flick_X_Lr = 21019,
        Var_Int_Controller_Flick_X_Lr_Rv = 21020,
        Var_Int_Controller_Flick_After_X_Lr_Rv = 21021,
        Var_Int_Item_Swing_1_Motion_Kind = 21022,
        Var_Int_Item_Swing_3_Motion_Kind = 21023,
        Var_Int_Item_Swing_4_Motion_Kind = 21024,
        Var_Int_Item_Swing_Dash_Motion_Kind = 21025,
        Var_Int_Item_Wait_Motion_Kind = 21026,
        Var_Int_Item_Squat_Wait_Motion_Kind = 21027,
        Var_Int_Win_Pose_Kind = 21028,
        Var_Int_Player_Color_Kind = 21029,
    };
