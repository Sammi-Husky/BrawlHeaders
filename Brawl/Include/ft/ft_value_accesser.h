...
//        Common_Param_Float_Dedede_SwallowedEscape_3 = 0xD5E,
    ...
    enum ParamInt {
        ...
        Common_Int_Damage_Drop_Smash_Ball = 0x5A17,
        Common_Int_Damage_Drop_Smash_Ball_Handicap = 0x5A18,

        Common_Int_Discretion_Final_Point_Diff = 0x5A1B,
        Common_Int_No_Discretion_Final_Beat_Count = 0x5A1C,
        Common_Int_Wall_Jump_interval_Frame = 0x5A1D,
        Common_Int_Wall_Jump_Flick_X = 0x5A1E,
        Common_Int_Wall_Jump_Stop_Frame = 0x5A1F,
        Common_Int_Wall_Jump_Disable_Cont_Frame = 0x5A20,
        Common_Int_Tread_Attack_Frame = 0x5A21, // TODO: Verify
        Common_Int_Attach_Wall_Frame = 0x5A22,
        Common_Int_Attach_Wall_Disable_Frame = 0x5A23,
        Common_Int_Shield_Min_Frame = 0x5A24,

        Common_Int_Shield_Just_Frame = 0x5A26,
        Common_Int_Continue_Just_Shield_Count = 0x5A27,
        Common_Int_Guard_Off_Cancel_Frame = 0x5A28,
        Common_Int_Catch_Dash_Frame = 0x5A29,
        Common_Int_Catch_Turn_Frame = 0x5A2A,

        Common_Int_Capture_Cut_Jump_Button_Count = 0x5A2C,
        Common_Int_Capture_Cut_Frame = 0x5A2D,
        Common_Int_Throw_Invincible_Frame = 0x5A2E,

        Common_Int_Damage_Fly_Attack_Frame = 0x5A30,
        Common_Int_Damage_Fly_Escape_Frame = 0x5A31,

        Common_Int_Rebirth_Wait_Frame = 0x5A3D,
        Common_Int_Rebirth_Invincible_Frame = 0x5A3E,

        Common_Int_Bury_Down_Frame = 0x5A40,
        Common_Int_Bury_Physics_Invalid_Frame = 0x5A41,
        Common_Int_Ice_Jump_Stiff_Frame = 0x5A42,

        Common_Int_Swim_Jump_Charge_Frame = 0x5A45,
        Common_Int_Swim_Jump_Speed_Y_Dec_Count = 0x5A46,
        Common_Int_Swim_Effect_Interval_Frame = 0x5A47,
        Common_Int_Swim_Drown_Frame = 0x5A48,
        Common_Int_Swim_Drown_Out_Frame = 0x5A49,
        Common_Int_Swim_Drown_Effect_Interval_Frame = 0x5A4A,

        Common_Int_Item_Throw_4_Flick = 0x5A54,
        Common_Int_Item_Air_Throw_4_Flick = 0x5A55,
        Common_Int_Item_Catch_Frame_Attack_Dash = 0x5A56,
        Common_Int_Item_Air_Catch_Frame = 0x5A57,
        Common_Int_Item_Air_Catch_Frame_Escape = 0x5A58,
        Common_Int_Item_No_Air_Catch_Frame = 0x5A59,
        Common_Int_Damage_Drop_Item = 0x5A5A,
        Common_Int_Damage_Drop_Item_Empty = 0x5A5B,

        Common_Int_Damage_Drop_Dragoon = 0x5A66,
        Common_Int_Damage_Drop_Dragoon_Handicap = 0x5A67,
        Common_Int_Dragoon_Invincible_Frame = 0x5A68,

        Common_Int_Gekikara_Frame = 0x5A6C,
        Common_Int_Gekikara_Fire_Shoot_Interval = 0x5A6D,
        Common_Int_Hammer_Frame = 0x5A6E,
        Common_Int_Hammer_Landing_Frame = 0x5A6F,
        Common_Int_Hammer_Throw_Frame = 0x5A70,
        Common_Int_Golden_Hammer_Frame = 0x5A71,
        Common_Int_Golden_Hammer_Hande_Frame = 0x5A72,
        Common_Int_Golden_Hammer_Beat_Dec_Frame = 0x5A73,
        Common_Int_Golden_Hammer_End_Flash_Frame = 0x5A74,
        Common_Int_Golden_Hammer_Drift_Frame = 0x5A75,
        //Common_Int_Golden_Hammer_ = 0x5A76,
