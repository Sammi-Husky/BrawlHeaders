...
class emPatapataParamAccesser : public emExtendParamAccesser {
public:
    emPatapataParamAccesser();
    virtual ~emPatapataParamAccesser();
...
static_assert(sizeof(emPatapataParamAccesser) == 0xC, "Class is the wrong size!");

extern emPatapataParamAccesser g_emKoopaParamAccesser;
